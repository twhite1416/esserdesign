...
<?php 
		...
		foreach($categories as $selfcate):
				...
				<div class="grid sectiontest2">
					...
					?>
						<div class="item b10" cat="<?php echo $cat; ?>" pid="<?php echo $project_query->post->ID; ?>">
							<a href="/<?php echo $cat; ?>/<?php echo $project_query->post->ID; ?>" class="hideable"><img class="img" style="z-index:1" src="<?php echo $thumb; ?>" height="150" width="150" /></a>
							<div class="img preventHomePageLinkage" style="z-index:0;"><a href="/<?php echo $cat; ?>/<?php echo $project_query->post->ID; ?>"><?php echo trim($name); ?></a></div>
						</div>
